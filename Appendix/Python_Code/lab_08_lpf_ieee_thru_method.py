import skrf as rf
import ieee_p370_2x_thru
# from ieee_p370_2x_thru import deembed_s_params
import numpy as np
...
s_side1, s_side2 = ieee_p370_2x_thru.ieee_p370_2x_thru(s_2xthru, use_ifft=False)
...
plt.title('S-parameters Before and After De-embedding')
...
plt.savefig('ieee_thru_sparameters_plot.png', dpi=300, bbox_inches='tight')
