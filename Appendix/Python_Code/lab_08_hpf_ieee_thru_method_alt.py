...
s_fixture_dut_fixture = rf.Network('hpf.s2p')
...
s_deembedded_dut.write_touchstone('hpf_ieee_deembedded_dut.s2p')

# Optional: Plot the results to verify
import matplotlib.pyplot as plt

plt.figure(figsize=(10, 6))
plt.title('HPF S-parameters Before and After De-embedding')
